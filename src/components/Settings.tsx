...
const Settings: React.FC<SettingsProps> = ({ theme, onThemeChange, resolvedTheme }) => {
  ...
  const renderProfileSettings = () => (
    <div className="space-y-6">
      ...
      <div>
        <h4 className="text-md font-medium text-gray-900 mb-3">Profile Picture</h4>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <p className="text-sm text-yellow-700 mt-1">Enhance your account security with 2FA</p>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                { location: 'San Francisco, US', time: '1 day ago', device: 'Safari on iPhone' },
                { location: 'London, UK', time: '3 days ago', device: 'Firefox on macOS' }
              ].map((activity, index) => (
