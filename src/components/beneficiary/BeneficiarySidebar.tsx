...
const BeneficiarySidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
    ...
    <>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex min-h-0 flex-1 flex-col bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <div className="flex h-16 items-center justify-center bg-purple-600 dark:bg-purple-700">
            <h1 className="text-xl font-bold text-white">Beneficiary Portal</h1>
          </div>
