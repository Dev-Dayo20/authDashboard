...
export const TypescriptClass = ({ name, age, status }: button) => {
  return (
    <>
      <div>Welcome to Typescript Class Component im </div>
      <button>
        {name} is {age} old
      </button>
...
export const childrenExample = ({ children }: childrenProps) => {
  return (
    <>
      <div className="bg-gray-400 p-4 rounded-xl flex items-center gap-4">
        <img
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-relaxed text-balance text-gray-500">
            ...
            voluptatem necessitatibus maiores, qui corporis odit debitis
